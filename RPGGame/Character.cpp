...
Character::Character(SDL_Setup* passed_SDL_Setup, float *passed_CameraX, float *passed_CameraY) {
	...
	cecil = new Sprite(sdl_setup->GetRenderer(), "C:\\Users\\Ginrai\\Desktop\\Game Programming\\Programming Files\\Game Assets\\ff42.png", 300, 300, 40, 60, CameraX, CameraY);
...
void Character::UpdateAnimation() {
	...
	if (tickCheck + 8 < SDL_GetTicks()) { //500 is half of a second. So it's in milliseconds.
